package com.example.sypicturebackend.manager.sharding;
...
public class DynamicShardingManager {
	...
	private void updateShardingTableNodes() {
		...
		// sy_picture.picture_112321321,sy_picture.picture_1123213123
		String newActualDataNodes = tableNames.stream()
				.map(tableName -> "sy_picture." + tableName) // 确保前缀合法
